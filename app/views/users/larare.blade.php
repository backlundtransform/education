...
<div ng-controller="UserController" >
	@if(Auth::user()->roles=='Admin')
 	...
 	<br /><b>Email:</b><br />
        	...
        	<input value="" type="text" ng-model="email">
   		<br />
		
		 	
 		  <button class="answer show-page-loading-msg"  ng-click="teach()" >Lägg till</button>

    	@endif
	
	
<input type="hidden" value="admin" id='role' class='role'>
	...
	<table data-role="table" class="my-custom-breakpoint" id="content" ng-table="tableParams">
		<thead>
			...
			<th>
				...
				@if(Auth::user()->roles=='Admin')
				<th>
					 <span class="show-page-loading-msg" ng-click="orderclick('active')" ng-model="order" >Aktiverad</span> 
					<span ng-model="image" > {{HTML::image('<% image.value %>')}}</span>
					</th>
				@endif
			...
			<th>
			  ...
			  <span class="show-page-loading-msg" ng-click="orderclick('updated_at')" ng-model="order" >Uppdaterad</span> 
				...
				@if(Auth::user()->roles=='Admin')	<th></th>	@endif
			</tr>
		</thead>
